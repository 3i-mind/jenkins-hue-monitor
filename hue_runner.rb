...
options = Trollop::options do
  opt :hue_url, "URL for the Hue light REST endpoint", :short => 'l', :type => :string, :default =>"https://hue.dnsk.io"
  opt :jenkins_url, "URL for the Jenkins 'view'", :short => 'j', :type => :string, :default => "https://j2.dnsk.io/api/json"  # https://j2.dnsk.io/view/Develop-Branches/api/json
